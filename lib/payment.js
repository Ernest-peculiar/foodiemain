...
module.exports = function createPaymentHandlers(dependencies) {
  const { DELIVERY_FEE, WHATSAPP_TOKEN, WHATSAPP_PHONE_NUMBER_ID, WHATSAPP_API_VERSION, PAYSTACK_SECRET_KEY, PUBLIC_URL, sendWhatsAppMessage, saveProfile, getVendorRecordById } = dependencies;
...
<body>
  ...
  async function handlePaystackChargeSuccess(data, supabase, ORDER_NOTIFY_NUMBER, getVendorPrepTimeButtonsReply) {
